    ...
    def get_response(self, message: str, stream: bool = True) -> str:
        ...
        try:
            ...
            if self.is_first_message:
                ...
                prompt = f"""Explain why some people are {self.stance} {self.subject}. Roleplay as if you are someone who has done a lot of research in
                this area. You are allowed to discuss policy, because all these subjects are not inflammatory. Argue it in first person. 
                Make sure to expand on your argument and cite claims ONLY with documents that have been provided.
                Do NOT explicitly say the phrase 'some sources'. Make sure to expand on your argument and cite specific claims with the documents."""
            else:
